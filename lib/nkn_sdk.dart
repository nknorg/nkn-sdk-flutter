...
class NknSdk {
  static const MethodChannel _methodChannel = const MethodChannel('org.nkn.sdk/common');
  ...
  static Future<void> installWalletPlugin() async {
    await _methodChannel.invokeMethod('installWalletPlugin');
  }
}
