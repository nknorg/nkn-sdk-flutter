 ...
 */
- (NknSubscribers* _Nullable)getSubscribers:(NSString* _Nullable)topic offset:(long)offset limit:(long)limit meta:(BOOL)meta txPool:(BOOL)txPool subscriberHashPrefix:(NSData* _Nullable)subscriberHashPrefix error:(NSError* _Nullable* _Nullable)error;
 ...
 */
- (BOOL)getSubscribersCount:(NSString* _Nullable)topic subscriberHashPrefix:(NSData* _Nullable)subscriberHashPrefix ret0_:(long* _Nullable)ret0_ error:(NSError* _Nullable* _Nullable)error;
...
RPC client.
 */
- (NknNanoPayClaimer* _Nullable)newNanoPayClaimer:(NSString* _Nullable)recipientAddress claimIntervalMs:(int32_t)claimIntervalMs lingerMs:(int32_t)lingerMs minFlushAmount:(NSString* _Nullable)minFlushAmount onError:(NknOnError* _Nullable)onError error:(NSError* _Nullable* _Nullable)error;
/**
...
compatibility.
 */
- (NknOnMessage* _Nullable)sendText:(NkngomobileStringArray* _Nullable)dests data:(NSString* _Nullable)data config:(NknMessageConfig* _Nullable)config error:(NSError* _Nullable* _Nullable)error;
...
addresses.
 */
- (BOOL)listen:(NkngomobileStringArray* _Nullable)addrsRe error:(NSError* _Nullable* _Nullable)error;
/**
 ...
 */
- (NknOnMessage* _Nullable)sendTextWithClient:(long)clientID dests:(NkngomobileStringArray* _Nullable)dests data:(NSString* _Nullable)data config:(NknMessageConfig* _Nullable)config error:(NSError* _Nullable* _Nullable)error;
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
@property (nonatomic) NkngomobileStringMap* _Nullable subscribers;
@property (nonatomic) NkngomobileStringMap* _Nullable subscribersInTxPool;
@end
...
// skipped variable NewStringArray with unsupported type: func(elems ...string) *github.com/nknorg/nkngomobile.StringArray

// skipped variable NewStringArrayFromString with unsupported type: func(s string) *github.com/nknorg/nkngomobile.StringArray

// skipped variable NewStringMap with unsupported type: func(m map[string]string) *github.com/nknorg/nkngomobile.StringMap

// skipped variable NewStringMapWithSize with unsupported type: func(size int) *github.com/nknorg/nkngomobile.StringMap
 ...
 * GetSubscribers wraps GetSubscribersContext with background context.
 */
FOUNDATION_EXPORT NknSubscribers* _Nullable NknGetSubscribers(NSString* _Nullable topic, long offset, long limit, BOOL meta, BOOL txPool, NSData* _Nullable subscriberHashPrefix, id<NknRPCConfigInterface> _Nullable config, NSError* _Nullable* _Nullable error);
 ...
 * GetSubscribersCount wraps GetSubscribersCountContext with background context.
 */
FOUNDATION_EXPORT BOOL NknGetSubscribersCount(NSString* _Nullable topic, NSData* _Nullable subscriberHashPrefix, id<NknRPCConfigInterface> _Nullable config, long* _Nullable ret0_, NSError* _Nullable* _Nullable error);
